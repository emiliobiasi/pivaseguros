                    ...
                    <div className="space-y-2">
                      <div className="rounded-md border border-amber-300 bg-amber-50 p-3 text-amber-900">
                        <div className="flex items-start gap-2">
                          ...
                          <p className="text-xs">
                            Dica: Para evitar problemas ao processar seus
                            anexos, use nomes de arquivos sem acentos (á, é, ã,
                            ç) e sem caracteres especiais. Prefira letras,
                            números, hífen (-) e sublinhado (_). Ex.:
                            laudo_incendio_2025.pdf
                          </p>
                        </div>
                      </div>
