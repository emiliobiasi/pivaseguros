        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4 bg-gray-100 p-4 rounded-lg">
            ...
            {seguro.telefone_contato && (
              <p>
                <strong>Telefone de Contato:</strong> {seguro.telefone_contato}
              </p>
            )}
            ...
            {seguro.nome_empresa_trabalho && (
              <p>
                <strong>Nome da Empresa:</strong> {seguro.nome_empresa_trabalho}
              </p>
            )}
            {seguro.data_emissao && (
              <p>
            ...
            {seguro.vinculo_empregaticio_conjuge && (
              <>
                ...
                {seguro.data_emissao_conjuge && (
                  <p>
                    <strong>Data de Emissão:</strong>{" "}
                    {new Date(seguro.data_emissao_conjuge).toLocaleDateString()}
                  </p>
                )}
                {seguro.fone_conjuge && (
                  <p>
          ...
          <div className="space-y-4 bg-gray-100 p-4 rounded-lg">
            ...
            {seguro.aluguel_imovel_alugado !== undefined && (
              <p>
                <strong>Aluguel:</strong> R${" "}
                {formatValor(seguro.aluguel_imovel_alugado.toFixed(2))}
              </p>
            )}
            {seguro.desp_ordinarias_cond_imovel_alugado !== undefined && (
              <p>
