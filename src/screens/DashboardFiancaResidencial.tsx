...
import {
  fetchSeguroFiancaResidencialList,
  subscribeToSeguroFiancaResidencialUpdates,
  unsubscribeFromSeguroFiancaResidencialUpdates,
...
export function DashboardFiancaResidencial() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const { items, totalPages } = await fetchSeguroFiancaResidencialList(
          page,
          limit,
          searchTerm,
  ...
  const handleSeguroFiancaResidencialChange = useCallback(
    (e: RecordSubscription<SeguroFiancaResidencial>) => {
      ...
      const matchesFilter =
        ...
        (currentSearchTerm === "" ||
          record.nome_residente
            .toLowerCase()
            .includes(currentSearchTerm.toLowerCase()) ||
          record.nome_imobiliaria_corretor
            .toLowerCase()
            .includes(currentSearchTerm.toLowerCase()) ||
  ...
  useEffect(() => {
    subscribeToSeguroFiancaResidencialUpdates(
      handleSeguroFiancaResidencialChange
    );
  ...
  return (
    <div>
      <TopBar
        title="Seguros de Fiança Residencial"
      ...
      <div>
        ...
        <FiancaResidencialTable data={data} />
